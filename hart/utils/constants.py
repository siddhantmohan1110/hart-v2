default_prompts = [
  "A detailed and realistic illustration of a tench fish swimming in clear water surrounded by aquatic plants",
    "A vivid underwater scene a goldfish swimming gracefully through clear water, surrounded by vibrant aquatic plants and small fish",
    "A detailed and realistic illustration of a great white shark swimming through deep blue ocean waters, surrounded by swirling waves and schools of fish",
    "Leatherback turtle swimming in the ocean near a coral reef, surrounded by colorful tropical fish and marine life",
    ]
