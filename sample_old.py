...
from hart.utils import default_prompts, encode_prompts, llm_system_prompt, safety_check, great_prompts
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="samples_without_system_prompt/",
    )
    parser.add_argument(
        "--store_seperately",
